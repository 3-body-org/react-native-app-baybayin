...
import { ScrollView, Text, StyleSheet, Image, View, TouchableOpacity, Modal, Dimensions } from "react-native";
import Card from "../components/card";
import lessonContent, { lessonModules } from "../data/lesson-data";
...
export default function AralinTab() {
  ...
  const renderLessonCard = (module) => (
    <TouchableOpacity
      ...
      activeOpacity={0.7}
    >
      <Card backgroundColor={"#FEF3EC"} style={styles.lessonCard}>
          ...
          <View style={styles.modalContainer}>
            ...
            >
              ...
              {module.content && (
                <View style={styles.section}>
                  <View style={styles.sectionHeader}>
                    <Text style={styles.sectionTitle}>{module.contentTitle}</Text>
              ...
              {module.examples && (
                <View style={styles.section}>
                  <View style={styles.sectionHeader}>
                    <Text style={styles.sectionTitle}>Halimbawa</Text>
                    <View style={styles.sectionTitleUnderline} />
                  </View>
